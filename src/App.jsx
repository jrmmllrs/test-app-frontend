...
const AdminResults = ({ token, onBack }) => {
      ...
      <nav className="bg-white shadow sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <h1 className="text-xl font-bold">Admin: Test Results</h1>
            <div></div>
          </div>
        </div>
      </nav>
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-lg">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="px-4 py-2 border-b">Taken At</th>
                </tr>
              </thead>
              <tbody>
                {results.map((r) => (
            ...
            <div className="mt-6">
              ...
              {user?.role === "admin" && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 mb-4 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 font-medium"
                >
                  View All Results
                </button>
              )}
...
// Take Test Component - FIXED VERSION
const TakeTest = ({ token, testId, onBack }) => {
  ...
  const fetchTest = async () => {
    try {
      console.log("Fetching test ID:", testId); // Debug log
...
// Create Test Component (unchanged)
